<footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div class="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8">
                <img class="h-7" src="{{asset('assets/logo/svg/Group-5.svg')}}" alt="Company name">
        ...
        <div class="pt-8 mt-16 border-t border-gray-900/10 sm:mt-20 lg:mt-24">
            <p class="text-xs leading-5 text-gray-500">&copy; 2020 {{config('app.name')}}, Inc. All rights reserved.</p>
        </div>
    </div>
</footer>
