<div class="overflow-hidden bg-white divide-y divide-gray-200 rounded-lg shadow">
            ...
            <div class="relative px-6 isolate pt-14 lg:px-8">
                ...
                <div class="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600">Lorem Ipsum is simply dummy text of the printing
                            and
                            typesetting industry.</p>
                        <div class="flex items-center justify-center mt-10 gap-x-6">
                            <a href="#"
                                class="w-1/3 rounded-md bg-primary-600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">
                                GO
                            </a>
                        </div>
                    </div>
    ...
    <section>
        <div class="relative px-6 py-24 overflow-hidden bg-white isolate sm:py-32 lg:px-8">
            <div
                class="absolute inset-0 -z-10 bg-[radial-gradient(45rem_50rem_at_top,theme(colors.primary.100),white)] opacity-20">
            </div>
            <div
                class="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-primary-600/10 ring-1 ring-primary-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center">
            </div>
            <div class="max-w-2xl mx-auto lg:max-w-4xl">
                <h1 class="text-4xl font-bold tracking-tight text-center text-gray-900 sm:text-6xl">About Us</h1>
                <figure class="mt-10">
                    <blockquote
                        class="text-xl font-semibold leading-8 text-center text-gray-900 sm:text-2xl sm:leading-9">
                    ...
                    <figcaption class="mt-10">
                        <div class="flex justify-center w-full gap-x-16">
                            <div>
                                <img class="w-20 h-20 mx-auto rounded-full bg-slate-500" src="#" alt="">
                                <div class="flex items-center justify-center mt-4 space-x-3 text-base">
                                    <div class="font-semibold text-gray-900">90k</div>
                                </div>
                            </div>
                            ...
                            <div>
                                <img class="w-20 h-20 mx-auto rounded-full bg-slate-500" src="#" alt="">
                                <div class="flex items-center justify-center mt-4 space-x-3 text-base">
                                    <div class="font-semibold text-gray-900">20k</div>
                                </div>
                            </div>
                            ...
                            <div>
                                <img class="w-20 h-20 mx-auto rounded-full bg-slate-500" src="#" alt="">
                                <div class="flex items-center justify-center mt-4 space-x-3 text-base">
                                    <div class="font-semibold text-gray-900">70k</div>
                                </div>
                            </div>
    ...
    <section>
        <div class="pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-slate-300">
            <div class="container mx-auto">
                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                            ...
                            <h4 class="mb-3 text-xl font-semibold text-dark">100+ Components</h4>
                            <p class="text-body-color">
                                We dejoy working with discerning clients, people for whom qualuty,
                                service, integrity & aesthetics.
                            </p>
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                            ...
                            <h4 class="mb-3 text-xl font-semibold text-dark">Speed Optimized</h4>
                            <p class="text-body-color">
                                We dejoy working with discerning clients, people for whom qualuty,
                                service, integrity & aesthetics.
                            </p>
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                            ...
                            <h4 class="mb-3 text-xl font-semibold text-dark">Regular Updates</h4>
                            <p class="text-body-color">
                                We dejoy working with discerning clients, people for whom qualuty,
                                service, integrity & aesthetics.
                            </p>
                ...
                <div class="-mx-4 text-center">
                    <button type="button"
                        class="inline-flex items-center px-6 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">View
                        More</button>
                </div>
            </div>
        </div>
    ...
    <section>
        <div>
            <div class="relative px-6 isolate lg:px-8">
                ...
                <div class="max-w-2xl py-16 mx-auto sm:py-32 lg:py-16">
                    <div class="text-center">
                        <p class="mt-6 text-lg leading-8 text-gray-600">Lorem Ipsum is simply dummy text of the
                            printing and
                            typesetting industry.</p>
                        <div class="flex items-center justify-center mt-10 gap-x-6">
                            <a href="#"
